        ...
        for (var a = 1; a <= sectionPosition; a++) {
          ...
          if (sectionName.name == content + '[section_code]') {
            ...
            (function () {
              ...
              var confirmImage = document.getElementsByName(content + '[section_image]')[0].files[0];
              var reader = new FileReader();
...
function addcontent(addcontent) {
  ...
  var newContent = document.querySelectorAll('.section_area')[place].querySelectorAll('.arr'); // nodelistを配列化
